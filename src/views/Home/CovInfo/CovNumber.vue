<template>
  <div class="num">
    <div class="content">
      <div class="title">截至{{ covData | time }}全国数据统计</div>
      <ul class="wrap">
        <li>
          <div class="number">
...
<style scoped>
    ...
    .num .wrap li:nth-child(3n)::after {
      content: "";
      border-right: 0;
    }
    .num .wrap .bold {
    ...
    .num .wrap li:nth-child(2) {
      color: rgb(18, 143, 14);
    }
    .num .wrap li:nth-child(3) {
      color: orange;
    }
    .num .wrap li:nth-child(4) {
      color: rgb(189, 19, 98);
    }
    .num .wrap li:nth-child(5) {
      color: rgb(223, 208, 7);
    }
    .num .wrap li:nth-child(6) {
      color: rgb(8, 110, 194);
    }
</style>